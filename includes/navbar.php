<?php
    include_once($_SERVER['/'].'classes/user.php');
    include_once($_SERVER['/'].'classes/functions.php');
    include_once($_SERVER['/'].'classes/tickets.php');
    include_once($_SERVER['/'].'classes/notifications.php');
...
<nav class="navBar">
    ...
    <div class="logo">
        <a id='site-name' href="index.php">Online Desk Support</a>
        <a id='site-name-mobile' href="index.php">DESK</a>
    </div>
