<?php
    ...
    include_once($_SERVER['/'].'classes/admin.php');
    ...
    <div class='inside-main'>
        ...
        <div class='form-manage' id='create-ticket-popup'>
            <form class="popup-create-ticket" method='POST'>
                ...
                <input class="" type="file" name="screenshot" id="">
                </div><br>



                <input class="submit-btn settings-list" type="submit" id="submitTicket" name="createTicket" value="Create Ticket">
            </form>
        </div>
    </div>
    </main>
