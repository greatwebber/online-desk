...
--
-- Host: localhost
-- Generation Time: Aug 22, 2021 at 07:46 PM
...
(267, 'kaywhytee234@gmail.com', 'user', 'Ticket', '2021-08-21 16:25:44', '129', ' has replied to your ticket (store). Click here to view.', 'False'),
(268, 'kaywhytee234@gmail.com', 'user', 'Ticket', '2021-08-21 16:29:58', '129', ' has replied to your ticket (store). Click here to view.', 'True'),
(269, 'admin2', 'kaywhytee234@gmail.com', 'addDepartment', '2021-08-21 16:39:09', '0', ' has added a new department (Food Store). Click here to view.', 'False'),
(270, 'admin2', 'kaywhytee234@gmail.com', 'addDepartment', '2021-08-21 16:46:02', '0', ' has added a new department (Pharmacy). Click here to view.', 'False'),
(271, 'admin2', 'kaywhytee234@gmail.com', 'addDepartment', '2021-08-21 16:47:58', '0', ' has added a new department (Storertt). Click here to view.', 'False'),
(272, 'admin2', 'kaywhytee234@gmail.com', 'addDepartment', '2021-08-21 16:51:07', '0', ' has added a new department (Store Management). Click here to view.', 'False'),
(273, 'admin2', 'user', 'Ticket', '2021-08-21 17:04:44', '130', ' has replied to your ticket (Product Exired). Click here to view.', 'True'),
(274, 'admin2', 'user', 'Ticket', '2021-08-21 17:27:36', '130', ' has replied to your ticket (Product Exired). Click here to view.', 'False'),
(275, 'admin2', 'user', 'assignedToUser', '2021-08-21 18:17:42', '131', ' has assigned admin2 to your ticket: Product Exired. You should get a response soon.', 'False'),
(276, 'admin2', 'user', 'assignedToUser', '2021-08-21 18:17:42', '130', ' has assigned admin2 to your ticket: Product Exired. You should get a response soon.', 'False');
...
(205, 129, 'kaywhytee234@gmail.com', '2021-08-21 16:25:44', 'ggfgg'),
(206, 129, 'kaywhytee234@gmail.com', '2021-08-21 16:29:58', 'klolll'),
(207, 130, 'admin2', '2021-08-21 17:04:43', 'which one of the products?'),
(208, 130, 'admin2', '2021-08-21 17:27:36', 'kkjkjjk');
...
(6, 'kaywhytee234@gmail.com', 'Software', 0, 0);
...
(129, 'user', NULL, 'store', 'Hardware', 'Low', 'gggggg', '2021-08-21 16:23:25', 'Active', '2021-08-21 16:29:58'),
(130, 'user', 'admin2', 'Product Exired', 'Store Management', 'High', 'washing machine now functioning well', '2021-08-21 17:03:51', 'In progress', '2021-08-21 17:27:36'),
(131, 'user', 'admin2', 'Product Exired', 'Pharmacy', 'Medium', 'weewdd', '2021-08-21 17:54:59', 'In progress', '2021-08-21 17:54:59');
...
(8, 'Mark', 'Angus', '09283928475', 'user', 'user@user.com', '$2y$10$ymI6Uu0PksYtLucW66n64e/qv2Mim/0KEA5ZbGZbJA29n9b7lmG0e', 0),
(16, 'test', 't', '23412345232', 'admin2', 'admin@admin2.com', '$2y$10$ymI6Uu0PksYtLucW66n64e/qv2Mim/0KEA5ZbGZbJA29n9b7lmG0e', 2),
(18, 'Mark', 'Angus', '07283927122', 'admin', 'admin@admin.com', '$2y$10$ymI6Uu0PksYtLucW66n64e/qv2Mim/0KEA5ZbGZbJA29n9b7lmG0e', 1),
...
--
ALTER TABLE `admin_speciality`
  MODIFY `specialityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `notifications`
  MODIFY `notificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=277;

--
-- AUTO_INCREMENT for table `replies`
--
ALTER TABLE `replies`
  MODIFY `replyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;
...
--
ALTER TABLE `tickets`
  MODIFY `ticketID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
